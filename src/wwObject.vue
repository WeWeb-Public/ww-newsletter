    ...
    methods: {
        ...
        saveAddress: async function () {
            ...
            try {
                ...
                console.log(err);
                this.loading = false;
                this.btnSendBgC = JSON.parse(JSON.stringify(this.wwObject.content.data.nokBtnSendBgC));
                btnSendElement.classList.add('after-click');
                afterTextElement.classList.add('after-text-anim');
                setTimeout(function () {
                    afterTextElement.classList.add('after-text');
        ...
        reset: function () {
            ...
            this.btnSendBgC = JSON.parse(JSON.stringify(this.wwObject.content.data.btnSendBgC || '#CBCBCB'));
            return;
        }
    },
    mounted: function () { }
